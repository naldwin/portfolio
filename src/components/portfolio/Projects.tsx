...
const projects: Project[] = [
    ...
    preview: (
      <div className="grid grid-cols-3 gap-2 p-4">
        {[78, 92, 65].map((v, i) => (
          <div
            key={i}
            className="bg-background/40 rounded-lg p-3 backdrop-blur"
          >
  ...
  },
  {
    ...
    preview: (
      <div className="p-4 space-y-2">
        ...
        <svg
          viewBox="0 0 200 50"
          className="w-full h-12 bg-background/40 rounded-lg p-2 backdrop-blur"
        >
          <polyline
  ...
  },
  {
    ...
    preview: (
      <div className="p-4">
        <div className="flex items-end gap-1.5 h-36 bg-background/40 rounded-lg p-3 backdrop-blur">
  ...
  },
  {
    ...
    preview: (
      <div className="p-4 space-y-2">
        <svg
          viewBox="0 0 200 80"
          className="w-full h-32 bg-background/40 rounded-lg p-2 backdrop-blur"
        >
          <defs>
          ...
          <path
            d="M0,60 Q40,30 80,40 T160,20 L200,30 L200,80 L0,80 Z"
            fill="url(#g1)"
          />

          <path
            d="M0,60 Q40,30 80,40 T160,20 L200,30"
            fill="none"
  ...
  },
  {
    ...
    preview: (
      <div className="p-4 space-y-2">
        <div className="bg-background/40 rounded-lg p-5 backdrop-blur">
    ...
    preview: (
      <div className="p-4 space-y-1.5">
        {[
          ...
          <div
            key={i}
            className="bg-background/40 rounded-md p-2 backdrop-blur flex items-center gap-2"
          >
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="mb-12 text-center space-y-3">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Production apps powering healthcare workflows, analytics, and
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((p, i) => (
            ...
            >
              ...
              <div
                className={cn(
                  "relative h-44 bg-gradient-to-br overflow-hidden border-b border-border/50",
                  p.gradient,
                )}
              >
                <div className="absolute inset-0 grid-pattern opacity-30" />
                <div className="relative h-full">{p.preview}</div>
                ...
                <div className="flex gap-2 pt-2">
                  {p.github ? (
                    ...
                    <Button
                      ...
                      variant="outline"
                      disabled
                      className="flex-1 glass border-primary/20 opacity-60"
                    >
                      <Github className="h-3.5 w-3.5 mr-1.5" />
                      Private
                    </Button>
