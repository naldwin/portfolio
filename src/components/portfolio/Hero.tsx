  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
        ...
        <div
          className="absolute top-1/3 -right-40 w-[500px] h-[500px] bg-secondary/20 rounded-full blur-3xl animate-blob"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute bottom-0 left-1/3 w-96 h-96 bg-accent/15 rounded-full blur-3xl animate-blob"
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-8 py-12">
        <div className="max-w-4xl mx-auto text-center space-y-10 animate-fade-in-up">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight leading-[0.95]">
            <span className="span">Naldwin</span>{" "}
            <span className="span gradient-text bg-[length:200%_auto] animate-gradient-shift">
              Cuengco
            </span>
          </h1>
          ...
          <div className="space-y-4">
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed px-3">
              Building scalable web apps, dashboards, and secure systems with
              modern technologies.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            ...
            <Button
              size="lg"
              variant="outline"
              className="glass border-primary/30 hover:border-primary/60 hover:bg-primary/10 hover:text-white"
              asChild
            >
            ...
            <Button
              ...
              className="hover:bg-muted hover:text-white"
            >
